...
03a-lengths-comp-figure-temporal-trends.R #yes SOM length comps through time plot
03b-temporal_depth_relationship.R #not sure
04-length-comparisons.R #not sure
DogfishTechReport.R # dont think i use

999-prediction-grid-generation.R
999-load-grid-data.R #<- load the grid for hbll n, s, and dog
999-load-hbll-n-s-grid.R #<- load the grid for hbll n, s